...
# Please follow installs from:  https://github.com/hrbrmstr/hrbrthemes
...
d1ac <- read.table(file = "./data/R/d5_clus_acc_ver1.csv", header = TRUE, sep = ",")
...
gene_clus_group_cn <- count(gene_clus_group)
