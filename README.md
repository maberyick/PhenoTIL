...
![Alt text](https://github.com/maberyick/PhenoTIL_V1/blob/main/data/test_set/test.png)
The figure plot for the identified cells (Green are the lymphocyte cells, Red the non-lymphocyte cells)
![Alt text](https://github.com/maberyick/PhenoTIL_V1/blob/main/output/matlab/identified_test.png)

### R output examples

The example plots generated by R
![Alt text](https://github.com/maberyick/PhenoTIL_V1/blob/main/output/R/Rplots-3.png)
![Alt text](https://github.com/maberyick/PhenoTIL_V1/blob/main/output/R/Rplots-6.png)
